...
```
Over the course of this project we built a total of five models:
...
![Ridge Lambda Plot](../images/ridgeCV-plot.png)
![Lasso Lambda Plot](../images/lassoCV-plot.png)

Next we consider the plots for MSEP as a function of the number of components taken in the PCR and PLS methods:
![PCR Lambda Plot](../images/pcrCV-plot.png)
![PLS Lambda Plot](../images/plsCV-plot.png)
...
print(coefTable, type = "html", caption.placement = "top")
